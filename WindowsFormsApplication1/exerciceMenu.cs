...
{
    public partial class exerciceMenu : Form
    {
        ...
        {
            cmd.CommandText = "select * from signs where Id in ( select idSign from asso_Exercices_Sign where idExercices =" + id + ") order by  id offset " + page*NUM_ON_PAGE + " rows fetch next " + NUM_ON_PAGE + " rows only;";
